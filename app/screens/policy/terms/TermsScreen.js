		...
		<ScrollView style={{backgroundColor: ColorMe.BACK_COLOR_1}}>
			<ContainerStl>
				<View style={[styles.container]}>
					...
					<>
						<p>Welcome to Lasciami Dire!</p>

						<p>
							These terms and conditions outline the rules and regulations for the use of Lasciami
							Dire's Website, located at www.lasciamidire.com.
						</p>

						<p>
							By accessing this website we assume you accept these terms and conditions. Do not
							continue to use Lasciami Dire if you do not agree to take all of the terms and
						...
						<p>
							We employ the use of cookies. By accessing Lasciami Dire, you agreed to use cookies in
							agreement with the Lasciami Dire's{" "}
						</p>
						<Text
							style={{
						...
						<p>
							Unless otherwise stated, Lasciami Dire and/or its licensors own the intellectual
							property rights for all material on Lasciami Dire. All intellectual property rights
							are reserved. You may access this from Lasciami Dire for your own personal use
							subjected to restrictions set in these terms and conditions.
						</p>

						<p>You must not:</p>
						<ul>
							<li>Republish material from Lasciami Dire</li>
							<li>Sell, rent or sub-license material from Lasciami Dire</li>
							<li>Reproduce, duplicate or copy material from Lasciami Dire</li>
							<li>Redistribute content from Lasciami Dire</li>
						</ul>

						<p>
							Parts of this website offer an opportunity for users to post and exchange opinions and
							information in certain areas of the website. Lasciami Dire does not filter, edit,
							publish or review Comments prior to their presence on the website. Comments do not
							reflect the views and opinions of Lasciami Dire,its agents and/or affiliates. Comments
							reflect the views and opinions of the person who post their views and opinions. To the
							extent permitted by applicable laws, Lasciami Dire shall not be liable for the
						...
						<p>
							Lasciami Dire reserves the right to monitor all Comments and to remove any Comments
						...
						<p>
							You hereby grant Lasciami Dire a non-exclusive license to use, reproduce, edit and
						...
						<p>
							...
							from the visibility of the hyperlink compensates the absence of Lasciami Dire; and (d)
						...
						<p>
							...
							linking to our website, you must inform us by sending an e-mail to Lasciami Dire.
						...
						<p>
							No use of Lasciami Dire's logo or other artwork will be allowed for linking absent a
