...
import {View, FlatList, Slider, TextInput, Keyboard, TouchableOpacity, Picker} from "react-native";
...
const LocalizaionView = (props) => {
	...
	return (
		<Container>
			...
			>
				{readTextInVoice && <Text style={styles.submitButtonText}> Go to Read Text </Text>}
				{!readTextInVoice && <Text style={styles.submitButtonText}> Go to translate Text </Text>}
			</TouchableOpacity>
			{!readTextInVoice && (
